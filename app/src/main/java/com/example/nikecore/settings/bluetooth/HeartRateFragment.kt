                        ...
                        if(e == null) {
                            mScanResults?.forEach {
                                ...
                                val item : LinearLayout =
                                    layoutInflater.inflate(R.layout.bluetooth_list, null) as LinearLayout
                                ...
                                val obj = object : BleWrapper.BleCallback {
                                    override fun onDeviceReady(gatt: BluetoothGatt, bleWrapper: BleWrapper) {
                                        ...
                                        for (gattService in gatt.services) {
                                            ...
                                            if (gattService.uuid == BleWrapper.HEART_RATE_SERVICE_UUID) {
                                                ...
                                                bleWrapper.getNotifications(gatt,gattService.uuid,gattService.getCharacteristic(
                                    ...
                                    override fun onDeviceDisconnected() {
                                        ...
                                        if(mConnections.any { con -> con.first.device.address == address.text.toString() }) {
                                            ...
                                            connect.setOnClickListener (null)
                                            connect.setOnClickListener {
                                                val mBleWrapper = BleWrapper(requireContext(), address.text.toString())
                                        ...
                                        {
                                            Toast.makeText(requireContext(),"Could not connect to the device :(",Toast.LENGTH_LONG).show()
                                        }
                                    }
